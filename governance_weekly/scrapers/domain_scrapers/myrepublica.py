...
class MyRepublicaScraper(BaseScraper):
    ...
    def run(self):
        ...
        # MyRepublica links: /news/story/{id}/ or /news/{category}/story/{id}/
        article_links = [l for l in links if "/news/story/" in l or "/news/corruption/" in l or "/news/politics/" in l]
